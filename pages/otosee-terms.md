---
layout: page
title: "OtoSee Terms of Use"
subheadline: "Terms of Use"
teaser: "Terms for using OtoSee with compatible Wi-Fi otoscope and inspection cameras."
...
## Observation only — not medical care

OtoSee is not a medical device and is not intended to diagnose, treat, cure, or prevent any disease or condition. Images, labels, annotations, voice notes, comparisons, and reports document observations only. They are not a diagnosis, clinical record, or substitute for advice from a qualified healthcare professional.

Stop using the otoscope and contact a qualified professional if you notice pain, bleeding, a sudden change in hearing, or another health concern. For an emergency, contact your local emergency services. Do not rely on OtoSee for emergency, safety-critical, or time-critical decisions.

## Safe and lawful use

You are responsible for using your camera hardware safely, following its manufacturer instructions, obtaining any necessary consent before recording another person, and complying with applicable law.

You must not use OtoSee to violate another person's privacy, access a device or network without authorization, create unlawful content, misrepresent an inspection as a professional diagnosis, or cause harm.
...
- The exact product, duration, localized price, taxes, and any eligible introductory offer are shown by StoreKit before purchase.
- A free trial applies only when it is displayed by OtoSee from current App Store information and Apple determines that the account is eligible.
- Payment is charged by Apple to the Apple Account used to confirm the purchase.
- The subscription renews automatically until canceled through Apple account subscription settings.
- Apple controls billing, renewal timing, cancellation, refund eligibility, storefront availability, and family or device access under its applicable terms.

Deleting OtoSee does not cancel a subscription. You can manage or cancel a subscription in Apple's subscription settings. OtoSee includes Restore Purchase for an eligible verified purchase.

When a subscription ends, OtoSee does not intentionally delete, watermark, or reduce the quality of previously saved inspection files. Existing history remains available for read-only viewing and sharing, and the app permits one retained inspection to remain editable under the current product design. Re-subscribing restores eligible Pro editing access.

## Your content and sharing

You retain your rights in photos, videos, recordings, notes, annotations, and reports you create. You grant OtoSee permission to process that content on your device solely to provide the features you request.

You are responsible for the content you create, the people whose information it includes, the recipients you choose, and the accuracy and appropriateness of any description. A recipient may copy or retain shared content. TCool LTD cannot recall files after you share or export them.
...
OtoSee is provided on an "as is" and "as available" basis to the extent permitted by law. TCool LTD does not warrant that every device will connect, every frame will be received, every export will complete, or every observation will be medically or technically accurate.

To the fullest extent permitted by applicable law, TCool LTD is not liable for indirect, incidental, special, consequential, or punitive damages, or for loss of data, revenue, opportunity, or use arising from OtoSee, incompatible hardware, user-created content, or a decision based on an observation or report.

Nothing in these Terms excludes warranties, consumer rights, or liabilities that cannot legally be excluded or limited.
...
We may update these Terms when OtoSee, its business model, or applicable requirements change. The current version will be published on this page with a revised effective date. Your continued use after an update constitutes acceptance to the extent permitted by law.

## Contact

Questions about these Terms can be sent to [dev@tcool.ltd](mailto:dev@tcool.ltd).
