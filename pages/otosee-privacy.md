...
- image annotations and before-and-after comparison settings;
...
OtoSee does not automatically send camera media, voice notes, subject names, or inspection notes to TCool LTD. If you choose to share a diagnostic log or contact support, we receive only the information you decide to provide. Before sending a log, review it and remove anything you do not want to share.

Support messages may be retained for as long as reasonably necessary to respond, maintain support history, prevent abuse, and meet legal obligations.

## Website access

When you open this Privacy Policy or the Terms of Use, your browser loads a page from `tcool.ltd`. The site is hosted through GitHub Pages and loads presentation resources through content-delivery and font providers, including Cloudflare's cdnjs, Google's WebFont loader, and Google Fonts. These providers may receive standard technical request information, such as IP address, browser user agent, requested resource, referring page, and request time, under their own privacy practices. OtoSee does not use these legal-page visits for behavioral advertising.

## Advertising, analytics, and data sales

OtoSee does not contain advertising, does not use third-party behavioral analytics, and does not sell personal information. OtoSee does not use inspection or health-related content for advertising, marketing profiles, or data-broker purposes.

## Data retention and deletion

App content remains on your device until you delete it, clear the app's data, or uninstall the app, subject to any device backups you control.
...
OtoSee is not directed to children under 13. A parent or guardian may use the app to make an observation record for a child, but should enter only information necessary for that purpose and remains responsible for any content they create or share. We do not knowingly collect children's inspection content through an OtoSee server because the app does not automatically upload inspection records to us.
...
We may update this Privacy Policy when OtoSee, its data practices, or applicable requirements change. The current version will be published on this page with a revised effective date.

## Contact

Questions or privacy requests can be sent to [dev@tcool.ltd](mailto:dev@tcool.ltd).
